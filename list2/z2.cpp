...
string Key = "a52355ef5dd6577b693dd1b57339caa198f009e837b70fc15ce059";
...
int main(int argc, char const *argv[]) {
  ...
  string Iv = "ad21c8b312eb588d3a87e3a4c11a1512";
  const char* kryptoBase64 = "Aax/19yDSExaomy7NHsG9pU8s6IeQQRybPLCbavz6A5bBpQH5Ah6TjtG+FDtqDHJ4xMUI82Wg/TxZQmi72Wa1pKdxOb2LUj/+qVIdvyRWjGGxBlZNgA1ALAxT0Qqw1mE0fDvSY04oMdvvIQQWjXWJQ==";
  ...
  thread first (fred, 0);
  thread sec (fred, 64);
  thread third (fred, 128);
  thread fourth (fred, 192);
